  ...
  <div class="user-page">
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="150" fixed="right">
        <template slot-scope="scope">
          <el-button size="mini" type="success" @click="reviewBar(scope.$index, scope.row)">审核</el-button>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页组件 -->
...
import { getBaritList, reviewBar } from "@/api/organization";
export default {
  data() {
    return {
      inputValue: "",
  ...
  methods: {
    ...
    getdata(parameter) {
      ...
      getBaritList(parameter).then(response => {
    ...
    review() {
      ...
      reviewBar(this.form.id, this.form.status).then(response => {
        this.$message({
